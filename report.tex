...
17856342
\end{BVerbatim}
\caption{Two leads concatenated}
\label{fig:two-leads-lb8}
\end{wrapfigure}
...
For example,
the following are all leads of the same method\footnote{This particular method is known as `Little
Bob Major'.} (we write the `leftover' row under a dashed line because it belongs to the lead
\emph{after} the others):
...
programs, conversations with well-known composers, and knowledge gained from experimenting with
prototypes early on in this project.
