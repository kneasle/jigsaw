...
Ringing'\footnote{The
\href{https://cccbr.github.io/method_ringing_framework/classification.html}{Framework for Method
Ringing}}, and the states representable in the application must be a superset of this definition.
...
Composition Library\footnote{Found at \href{https://complib.org/}{https://complib.org/}} (usually
...
(Dec 3, Poll linked
below\footnote{\href{link}{https://www.facebook.com/groups/601658156640471/permalink/2097786800360925}})

Having lain down a rough initial design, I wanted to see what other composers thought of it before
investing large amounts of time exploring a dead-end in the space of compositions.  I am self-taught
in composing, and it's entirely possible that I have a completely non-standard workflow.
...
most composers compose by hand.  Of these, nearly everyone builds up compositions from small pieces
and agrees that my design would be interesting and potentially useful.
...
effort into good documentation for this library so it can be easily used in other projects or by
other developers.

Initially, I thought that the concept of rows and permutations were different enough to warrant
separate data types.  My thinking was that a \verb|Row| is a sequence of \verb|Bell|s (plus some
additional invariants), and a permutation can be thought of as a function of type \verb|[a] -> [a]|
which can permute sequences of any item.  Mathematically this feels like an elegant separation, but
using the library in ernest made me realise that the \verb|Perm| doesn't pull its weight given its
large overlap with the \verb|Row| type.  I would almost always use \verb|Perm| as an intermediate
step to use one \verb|Row| to permute another.  Therefore, a few months later (Feb 9th, 81d1120) the
operations of the \verb|Perm| structure was merged into \verb|Row|.
